...
let vrecog=null, vlistening=false;
function vlisten(){
  ...
  vrecog.onstart=()=>{ vlistening=true; btn.classList.add("on"); };
  vrecog.onend=()=>{ vlistening=false; btn.classList.remove("on"); };
  vrecog.onerror=e=>{ vlistening=false; btn.classList.remove("on");
